    ...
    states: [
        State {
            ...
            PropertyChanges {
                 ...
                 */
                height: Math.min(Plasmoid.configuration.showDate || timeZoneLabel.visible ? main.height * 0.40 : main.height * 0.71,
