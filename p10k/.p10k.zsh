...
typeset -g WHITE="#eeeeee"
typeset -g BLACK="#1E1E2E" # Mantle - Mocha
typeset -g GREEN="#a6e3a1"  # NodeJS logo's color
...
typeset -g STATUS_OK_BACKGROUND=$GREEN
typeset -g STATUS_OK_FOREGROUND=$BLACK


typeset -g STATUS_ERROR_BACKGROUND=$RED
typeset -g STATUS_ERROR_FOREGROUND=$BLACK
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION=' 󰸱'
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$DIR_FOREGROUND
