...
return {
  ...
  },
  {
    ...
    opts = function()
      ...
      local sources = require('plugins.features.completion.blink-cmp.config.sources')
      local appearance = require('plugins.features.completion.blink-cmp.config.appearance')
