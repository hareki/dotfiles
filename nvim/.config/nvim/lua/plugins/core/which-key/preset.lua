...
M.motions = {
  ...
  { '%', desc = 'Cycle Within Matching Group' },
...
M.text_objects = {
  ...
  preset = true,
  { 'a', group = 'Around' },
  { 'a"', desc = 'Around " String' },
  { "a'", desc = "Around ' String" },
  { 'a%', desc = 'Around Matching Word' },
  { 'a(', desc = 'Around [(]) Block' },
  { 'a)', desc = 'Around [(]) Block' },
  { 'a<', desc = 'Around <> Block' },
  { 'a>', desc = 'Around <> Block' },
  { 'aB', desc = 'Around [{]} Block' },
  { 'aW', desc = 'Around WORD with Whitespace' },
  { 'a[', desc = 'Around [] Block' },
  { 'a]', desc = 'Around [] Block' },
  { 'a`', desc = 'Around ` String' },
  { 'ab', desc = 'Around [(]) Block' },
...
M.g = {
  ...
  { 'g,', desc = 'Go to [count] Newer Position in Change List', icon = Icons.navigation.right },
  { 'g;', desc = 'Go to [count] Older Position in Change List', icon = Icons.navigation.left },
