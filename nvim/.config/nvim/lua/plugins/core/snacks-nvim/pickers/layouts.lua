--- @class plugins.core.snacks-nvim.pickers.layouts
local M = {}

--- @class plugins.core.snacks-nvim.pickers.layouts.Opts
...
--- @param opts plugins.core.snacks-nvim.pickers.layouts.Opts
